<script setup lang="ts">
  ...
  const handlePreview = async (record: NodeRecord): Promise<void> => {
    ...
    googlepreviewUrl = `${googlepreviewUrl}${hostUrl}${data.fileId}`;
  ...
  >
    ...
    <div class="preview-content">
      <div class="preview-header">
        <button class="close-btn" type="button" @click.stop="hidePreview"
          >&times;</button
        >
    ...
    <a-space direction="vertical" class="container">
      ...
      >
        ...
        <template #fileName="{ row, record }">
          ...
          <div v-else class="netdisk-table-tr__name" @click.stop="handlePreview(record)">
            <IconFont
              type="icon-file2"
              :size="18"
              style="vertical-align: sub"
